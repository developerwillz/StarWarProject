...
/***/ "./src/app/star-war-service.service.ts":
/*!*********************************************!*\
  !*** ./src/app/star-war-service.service.ts ***!
  \*********************************************/
/*! exports provided: selectType, StarWarServiceService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "selectType", function() { return selectType; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "StarWarServiceService", function() { return StarWarServiceService; });
...
(function (selectType) {
    selectType["all"] = "";
    selectType["character"] = "people";
    selectType["planet"] = "planets";
    selectType["starship"] = "starships";
})(selectType || (selectType = {}));
var StarWarServiceService = /** @class */ (function () {
    // currentSpecies: any;
    function StarWarServiceService(http) {
        this.http = http;
        this.APIurl = 'https://swapi.co/api/';
    }
    StarWarServiceService.prototype.getAllResult = function (type, feedback) {
        return this.http.get("" + type);
    };
    StarWarServiceService.prototype.getResult = function (type) {
        return this.http.get("" + type);
    };
    StarWarServiceService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
            providedIn: 'root'
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]])
    ], StarWarServiceService);
    return StarWarServiceService;
}());
